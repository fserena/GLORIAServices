...
public interface RTDBService {
	...
	public void setDescription(@Param(value="name_")String name, @Param(value="description_")String description);
	public String getDescription(@Param(value="name_")String name);
	public void setPublicKey(@Param(value="name_")String name, @Param(value="pk_")String pk);
	public String getPublicKey(@Param(value="name_")String name);
	public void setCoordinates(@Param(value="name_")String name, @Param(value="lat_")double latitude, @Param(value="long_")double longitude);
	public double getLongitude(@Param(value="name_")String name);
	public double getLatitude(@Param(value="name_")String name);
	public RTAvailabilityEntry getAvailability(@Param(value="name_")String name);
	public void setStartingAvailability(@Param(value="name_")String name, @Param(value="starting_")Date starting);
	public void setEndingAvailability(@Param(value="name_")String name, @Param(value="ending_")Date ending);
