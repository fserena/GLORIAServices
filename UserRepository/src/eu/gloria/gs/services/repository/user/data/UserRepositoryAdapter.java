...
public class UserRepositoryAdapter {
	...
	final String ADMIN_NAME = "gloria-admin";
	final String ADMIN_PWD = "gl0r1@-@dm1n";
	final String USER_REPOSITORY_NAME = "user-repository";
	final String USER_REPOSITORY_PWD = "us3r-r3p0s1t0ry";
	final String RT_REPOSITORY_NAME = "rt-repository";
	final String RT_REPOSITORY_PWD = "rt-r3p0s1t0ry";
	final String ACTION_LOG_NAME = "action-log";
	final String ACTION_LOG_PWD = "@ct10n-l0g";
	final String TELEOPERATION_NAME = "teleoperation";
	final String TELEOPERATION_PWD = "t3l30p3r@t10n";
	final String EXPERIMENT_NAME = "experiment";
	final String EXPERIMENT_PWD = "3xp3r1m3nt";
	final String LIFERAY_NAME = "liferay";
	final String LIFERAY_PWD = "l1f3r@y";
	final String IMAGE_REPOSITORY_NAME = "image_repository";
	final String IMAGE_REPOSITORY_PWD = "1m@g3_r3p0s1t0ry";
