 ...
 * 
 */
public class MoveSouth extends ServiceOperation {
	...
	public void execute() throws ExperimentOperationException {
		...
		try {
			...
			if (currentMoves > -maxMoves) {
				...
				ExperimentOperationException ex = new ExperimentOperationException(this.getContext().getName(), "on south limit");
