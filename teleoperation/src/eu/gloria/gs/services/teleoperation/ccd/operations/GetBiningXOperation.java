...
public class GetBiningXOperation extends CCDOperation {

	public GetBiningXOperation(OperationArgs args) throws Exception {
		super(args);
	}
	...
	protected void operateCCD(CCD ccd, OperationReturn returns)
		...
		long binX = ccd.getBiningX();

		returns.setReturns(new ArrayList<Object>());
		returns.getReturns().add(binX);
