...
public class GainIsModifiableOperation extends CCDOperation {

	public GainIsModifiableOperation(OperationArgs args) throws Exception {
		super(args);
	}
	...
	protected void operateCCD(CCD ccd, OperationReturn returns)
		...
		boolean auto = ccd.gainIsModifiable();
