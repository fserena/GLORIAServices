...
public class RTScriptDBAdapter {
	...
	public synchronized int addRTScript(String user, String experiment,
			...
			String result, boolean notify) throws ExperimentDatabaseException,
	...
	public void removeRTScript(int sid) throws ExperimentDatabaseException {
		try {
	...
	public RTScriptInformation getRTScriptInformation(int sid)
			throws ExperimentDatabaseException, NoSuchScriptException {
	...
	public List<RTScriptInformation> getAllScriptsActiveNow()
			throws ExperimentDatabaseException, NoScriptsAvailableException {
	...
	public void prepareAllDailyNotActive() throws ExperimentDatabaseException,
	...
	public void setScriptScheduled(int sid) throws ExperimentDatabaseException {
		try {
	...
	public void setScriptReady(int sid) throws ExperimentDatabaseException {
		try {
	...
	public void setScriptDone(int sid) throws ExperimentDatabaseException {
		try {
	...
	public void setScriptNotifying(int sid) throws ExperimentDatabaseException {
		try {
	...
	public void setScriptPrepared(int sid) throws ExperimentDatabaseException {
		try {
	...
	public void setScriptTriggered(int sid) throws ExperimentDatabaseException {
		try {
	...
	public void setScriptWaitingEnd(int sid) throws ExperimentDatabaseException {
		try {
	...
	public void setScriptError(int sid) throws ExperimentDatabaseException {
		try {
